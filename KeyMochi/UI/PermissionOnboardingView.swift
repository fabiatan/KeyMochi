...
struct PermissionOnboardingView: View {
    ...
    var body: some View {
        ...
        .alert("Permission granted — restart to continue",
            ...
            Text("KeyMochi needs to restart to start listening to keystrokes.")
        }
    }
    ...
    private var ungrantedView: some View {
        VStack(spacing: 12) {
            ...
            Text("Accessibility Permission Needed")
                .font(.title2).bold()
            Text("KeyMochi needs to observe your keystrokes to play matching keyboard sounds. This is handled entirely on-device.")
            ...
            Text("Toggle KeyMochi on in System Settings → Privacy & Security → Accessibility.")
                .font(.caption)
                .foregroundStyle(.secondary)
        }
    }
    ...
    private var grantedView: some View {
        VStack(spacing: 12) {
            ...
            Text("KeyMochi is listening. Type to hear it.")
                .foregroundStyle(.secondary)
